...
import { buildTypePage } from '@/lib/registry/registryEntityPage';
import { allTypes, typeById } from '@/lib/registry/registryEntities';
...
export function generateStaticParams() {
  return allTypes().map((p) => ({ id: p.id.toLowerCase() }));
}
