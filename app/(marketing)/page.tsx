 ...
 *
 * Un SEUL CTA (chaîne institutionnelle verrouillée) → /establish. Le message
 * central : on n'ouvre pas un compte, on ÉTABLIT une identité professionnelle.
 * SSR statique.
 * =====================================================================
 */
      ...
      <main className="mx-auto max-w-[1200px] px-6">
        ...
        <section className="grid grid-cols-1 items-center gap-breathe-lg py-breathe-xl md:grid-cols-2">
          <div className="max-w-[560px]">
            ...
            {/* Le CTA UNIQUE — commande d'interface, localisée. */}
            <div className="mt-12">
              <Link
                href="/establish"
